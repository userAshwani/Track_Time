...
| Landing page | Login |
|---|---|
| ![Landing page](image.png) | ![Login](image-2.png) |

| Dashboard overview | All Tasks |
|---|---|
| ![Dashboard overview](image-3.png) | ![All Tasks](image-4.png) |

| Time Tracker | Daily Schedule |
|---|---|
| ![Time Tracker](image-5.png) | ![Daily Schedule](image-6.png) |

| Categories | Summary & Reports |
|---|---|
| ![Categories](image-7.png) | ![Summary and reports](image-8.png) |

| Profile & streak | Public streak profile |
|---|---|
| ![Profile settings and streak](image-9.png) | ![Public streak profile](image-10.png) |
